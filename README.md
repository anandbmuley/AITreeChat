...
### Main Tree View & Thread Drawer

![Main Tree View](images/Node%20hierarchy.jpeg)

### Interactive Tree Graph Visualizer

![Interactive Tree Graph View](images/Tree%20view.jpeg)

### Tree Complexity & Model Recommendation

![Tree Complexity Model Recommendation](images/Node%20details.jpeg)
...
| :----------------------- | :--------------- | :------------------- | :--------------------------------------------------------------------------------- |
| 🟢 **Low Complexity**    | $C < 8$          | **Gemini 3.5 Flash-Lite** | Quick Q&A, simple follow-up prompts, single-turn replies                           |
| 🟡 **Medium Complexity** | $8 \le C \le 18$ | **Gemini 3.8 Flash** | Standard technical threads, moderate code analysis                                 |
| 🔴 **High Complexity**   | $C > 18$         | **Gemini 3.1 Pro**   | Deep ancestral paths ($6+$ nodes), complex multi-branch forks, intensive reasoning |
