      ...
      <div className="space-y-4 overflow-y-auto pr-1">
        ...
        <div className="bg-slate-50 dark:bg-slate-900/60 border border-slate-200 dark:border-slate-800/80 rounded-xl p-2.5 space-y-2">
          <div className="flex items-center justify-between text-[11px] font-semibold text-slate-500 dark:text-slate-400 uppercase tracking-wider">
            <span className="flex items-center gap-1.5">
              ...
              <Moon className="w-3.5 h-3.5 text-indigo-400 hidden dark:inline" />
              Theme Mode
            </span>
        ...
        <div className="relative">
          ...
          <input
            ...
            className="w-full bg-slate-100 dark:bg-slate-900 border border-slate-200 dark:border-slate-800 focus:border-indigo-500 rounded-xl py-2 pl-9 pr-3 text-xs text-slate-900 dark:text-slate-200 placeholder-slate-400 dark:placeholder-slate-500 outline-none transition"
          />
        </div>
        ...
        <button
          ...
          className="w-full flex items-center justify-center gap-2 py-2 bg-indigo-50 dark:bg-indigo-900/40 hover:bg-indigo-100 dark:hover:bg-indigo-800/50 border border-indigo-200 dark:border-indigo-700/50 text-indigo-700 dark:text-indigo-200 rounded-xl text-xs font-semibold shadow-sm transition"
        >
        ...
        <div className="bg-slate-50 dark:bg-slate-900/60 border border-slate-200 dark:border-slate-800/80 rounded-xl p-3 space-y-2.5">
          ...
          <select
            ...
            className="w-full bg-white dark:bg-slate-950 border border-slate-200 dark:border-slate-800 text-xs text-slate-800 dark:text-slate-200 rounded-lg p-2 outline-none focus:border-indigo-500 transition cursor-pointer"
          >
        ...
        <div className="space-y-2.5">
          <div className="bg-slate-50 dark:bg-slate-900/60 border border-slate-200 dark:border-slate-800/80 rounded-xl p-3 text-xs space-y-2">
            <div className="flex items-center justify-between text-slate-700 dark:text-slate-300">
              ...
              <span className="font-mono text-indigo-700 dark:text-indigo-300 font-bold bg-indigo-100 dark:bg-indigo-950/80 px-2 py-0.5 rounded border border-indigo-200 dark:border-indigo-800/60">
                {nodeCount}
              </span>
            </div>
          ...
          <div className="bg-slate-50 dark:bg-slate-900/60 border border-slate-200 dark:border-slate-800/80 rounded-xl p-3 text-xs">
      ...
      <div className="pt-3 border-t border-slate-200 dark:border-slate-800/80 space-y-2 text-[11px]">
        ...
        <div className="flex items-center justify-between gap-2">
          <button
            ...
            className="flex-1 flex items-center justify-center gap-1.5 py-1.5 bg-slate-100 dark:bg-slate-900 hover:bg-slate-200 dark:hover:bg-slate-800 border border-slate-200 dark:border-slate-800 text-slate-700 dark:text-slate-300 rounded-lg transition"
        ...
        <button
          ...
          className="w-full flex items-center justify-center gap-1.5 py-1 text-slate-400 dark:text-slate-500 hover:text-rose-500 transition"
        >
        ...
        <div className="pt-1 flex items-center justify-between text-[10px] text-slate-400 dark:text-slate-500">
          <span className="flex items-center gap-1">
            <Sparkles className="w-3 h-3 text-amber-500" /> AI Tree Engine
          </span>
          <span>v1.0.0</span>
        </div>
      </div>
